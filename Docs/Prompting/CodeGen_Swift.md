    ...
    <instructions>
        ...
        1. **Interpret the Graph(s)**
           ...
           - If multiple graphs are present, then each one must be converted and added to the graphs property.
             ...
             - **Construction** or **Animation** graphs: These might not have direct equivalents in Swift, but you should still produce a Swift function that replicates the flow of logic.
        ...
        6. **If the user provides an existing .swift file or module**:
    ...
    <responseFormat>
        ...
        **Field Requirements**:
        ...
        4. **code**: An object holding three string fields:
           - "graphDeclaration": This should be left empty since Swift does not use declaration files.
           - "graphImplementation": The Swift code that implements the flow logic from the Blueprint nodes.
           - "implementationNotes": Any extra notes or clarifications needed to replicate the Blueprint’s behavior in Swift.
